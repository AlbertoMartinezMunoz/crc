#include <crc/crc16dds110.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16Dds110Test : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Dds110>();
    }
