#include <crc/crc16en13757.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16En13757Test : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16En13757>();
    }
