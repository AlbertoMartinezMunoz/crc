#include <crc/crc8dvbs2.h>

#include <memory>

#include <gtest/gtest.h>

class Crc8Dvbs2Test : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc8Dvbs2>();
    }
