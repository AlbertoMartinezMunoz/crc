#include <crc/crc16ccittfalse.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16CcittfalseTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Ccittfalse>();
    }
