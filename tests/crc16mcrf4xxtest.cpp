#include <crc/crc16mcrf4xx.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16Mcrf4xxTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Mcrf4xx>();
    }
