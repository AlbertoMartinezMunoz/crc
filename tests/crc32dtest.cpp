#include <crc/crc32d.h>

#include <memory>

#include <gtest/gtest.h>

class Crc32DTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc32D>();
    }
