#include <crc/crc16t10dif.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16T10difTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16T10dif>();
    }
