#include <crc/crc16augccitt.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16AugccittTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Augccitt>();
    }
