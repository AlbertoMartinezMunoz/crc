#include <crc/crc16xmodem.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16XmodemTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Xmodem>();
    }
