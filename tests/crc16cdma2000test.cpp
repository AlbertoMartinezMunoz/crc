#include <crc/crc16cdma2000.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16Cdma2000Test : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Cdma2000>();
    }
