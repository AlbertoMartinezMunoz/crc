#include <crc/crc32jamcrc.h>

#include <memory>

#include <gtest/gtest.h>

class Crc32JamcrcTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc32Jamcrc>();
    }
