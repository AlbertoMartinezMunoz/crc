#include <crc/crc16arc.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16ArcTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Arc>();
    }
