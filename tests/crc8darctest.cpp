#include <crc/crc8darc.h>

#include <memory>

#include <gtest/gtest.h>

class Crc8DarcTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc8Darc>();
    }
