#include <crc/crc16x25.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16X25Test : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16X25>();
    }
