#include <crc/crc8rohc.h>

#include <memory>

#include <gtest/gtest.h>

class Crc8RohcTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc8Rohc>();
    }
