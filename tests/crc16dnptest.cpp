#include <crc/crc16dnp.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16DnpTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Dnp>();
    }
