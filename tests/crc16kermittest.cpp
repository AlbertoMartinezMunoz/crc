#include <crc/crc16kermit.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16KermitTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Kermit>();
    }
