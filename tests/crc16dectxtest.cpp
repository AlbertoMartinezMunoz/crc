#include <crc/crc16dectx.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16DectxTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Dectx>();
    }
