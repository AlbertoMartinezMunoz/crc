#include <crc/crc16modbus.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16ModbusTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Modbus>();
    }
