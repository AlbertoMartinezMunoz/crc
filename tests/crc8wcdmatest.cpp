#include <crc/crc8wcdma.h>

#include <memory>

#include <gtest/gtest.h>

class Crc8WcdmaTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc8Wcdma>();
    }
