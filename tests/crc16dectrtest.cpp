#include <crc/crc16dectr.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16DectrTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Dectr>();
    }
