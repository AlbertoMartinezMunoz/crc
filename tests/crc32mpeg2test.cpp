#include <crc/crc32mpeg2.h>

#include <memory>

#include <gtest/gtest.h>

class Crc32Mpeg2Test : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc32Mpeg2>();
    }
