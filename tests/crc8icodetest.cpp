#include <crc/crc8icode.h>

#include <memory>

#include <gtest/gtest.h>

class Crc8IcodeTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc8Icode>();
    }
