#include <crc/crc32posix.h>

#include <memory>

#include <gtest/gtest.h>

class Crc32PosixTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc32Posix>();
    }
