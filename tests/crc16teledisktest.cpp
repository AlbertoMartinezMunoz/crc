#include <crc/crc16teledisk.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16TelediskTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Teledisk>();
    }
