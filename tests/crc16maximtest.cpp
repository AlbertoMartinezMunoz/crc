#include <crc/crc16maxim.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16MaximTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Maxim>();
    }
