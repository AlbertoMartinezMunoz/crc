#include <crc/crc8itu.h>

#include <memory>

#include <gtest/gtest.h>

class Crc8ItuTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc8Itu>();
    }
