#include <crc/crc32xfer.h>

#include <memory>

#include <gtest/gtest.h>

class Crc32XferTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc32Xfer>();
    }
