#include <crc/crc32bzip2.h>

#include <memory>

#include <gtest/gtest.h>

class Crc32Bzip2Test : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc32Bzip2>();
    }
