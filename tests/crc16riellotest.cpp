#include <crc/crc16riello.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16RielloTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16Riello>();
    }
