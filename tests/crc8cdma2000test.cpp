#include <crc/crc8cdma2000.h>

#include <memory>

#include <gtest/gtest.h>

class Crc8Cdma2000Test : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc8Cdma2000>();
    }
