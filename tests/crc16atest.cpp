#include <crc/crc16a.h>

#include <memory>

#include <gtest/gtest.h>

class Crc16ATest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc16A>();
    }
