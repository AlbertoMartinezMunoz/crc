#include <crc/crc8ebu.h>

#include <memory>

#include <gtest/gtest.h>

class Crc8EbuTest : public ::testing::Test
{
public:
    virtual void SetUp()
    {
        m_crc = std::make_unique<Crc8Ebu>();
    }
