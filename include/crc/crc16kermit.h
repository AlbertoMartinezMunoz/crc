#ifndef CRC_CRC16KERMIT_H
#define CRC_CRC16KERMIT_H

#include <crc/crc.h>

class Crc16Kermit : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Kermit() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
