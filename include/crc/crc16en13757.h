#ifndef CRC_CRC16EN13757_H
#define CRC_CRC16EN13757_H

#include <crc/crc.h>

class Crc16En13757 : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16En13757() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
