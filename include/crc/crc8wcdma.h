#ifndef CRC_CRC8WCDMA_H
#define CRC_CRC8WCDMA_H

#include <crc/crc.h>

class Crc8Wcdma : public Crc<uint8_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc8Wcdma() : Crc<uint8_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}

private:
    uint8_t reflectData(uint8_t data) override
    {
        return Crc<uint8_t>::reflect(data, 8);
    }

    uint8_t reflectRemainder(uint8_t remainder) override
    {
        return Crc<uint8_t>::reflect(remainder, Crc::m_typeBits);
    }
...
private:
    ...
    static const uint8_t m_initialRemainder = 0x00;
};


#endif //CRC_CRC8WCDMA_H
