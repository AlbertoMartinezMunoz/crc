#ifndef CRC_CRC16CCITTFALSE_H
#define CRC_CRC16CCITTFALSE_H

#include <crc/crc.h>

class Crc16Ccittfalse : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Ccittfalse() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
