#ifndef CRC_CRC16DNP_H
#define CRC_CRC16DNP_H

#include <crc/crc.h>

class Crc16Dnp : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Dnp() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
