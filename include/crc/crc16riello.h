#ifndef CRC_CRC16RIELLO_H
#define CRC_CRC16RIELLO_H

#include <crc/crc.h>

class Crc16Riello : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Riello() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
...
private:
    ...
    static const uint16_t m_initialRemainder = 0xB2AA;
};


#endif //CRC_CRC16RIELLO_H
