#ifndef CRC_CRC16MCRF4XX_H
#define CRC_CRC16MCRF4XX_H

#include <crc/crc.h>

class Crc16Mcrf4xx : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Mcrf4xx() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
