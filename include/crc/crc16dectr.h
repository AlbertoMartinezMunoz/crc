#ifndef CRC_CRC16DECTR_H
#define CRC_CRC16DECTR_H

#include <crc/crc.h>

class Crc16Dectr : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Dectr() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
...
private:
    ...
    static const uint16_t m_finalXorValue = 0x0001;
    static const uint16_t m_initialRemainder = 0x0000;
};


#endif //CRC_CRC16DECTR_H
