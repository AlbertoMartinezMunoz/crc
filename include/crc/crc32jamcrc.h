#ifndef CRC_CRC32JAMCRC_H
#define CRC_CRC32JAMCRC_H

#include <crc/crc.h>

class Crc32Jamcrc : public Crc<uint32_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc32Jamcrc() : Crc<uint32_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
