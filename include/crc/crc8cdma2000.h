#ifndef CRC_CRC8CDMA2000_H
#define CRC_CRC8CDMA2000_H

#include <crc/crc.h>

class Crc8Cdma2000 : public Crc<uint8_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc8Cdma2000() : Crc<uint8_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
