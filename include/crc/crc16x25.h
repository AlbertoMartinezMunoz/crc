#ifndef CRC_CRC16X25_H
#define CRC_CRC16X25_H

#include <crc/crc.h>

class Crc16X25 : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16X25() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
