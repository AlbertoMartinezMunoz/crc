#ifndef CRC_CRC16MODBUS_H
#define CRC_CRC16MODBUS_H

#include <crc/crc.h>

class Crc16Modbus : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Modbus() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
