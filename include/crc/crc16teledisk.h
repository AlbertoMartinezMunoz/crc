#ifndef CRC_CRC16TELEDISK_H
#define CRC_CRC16TELEDISK_H

#include <crc/crc.h>

class Crc16Teledisk : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Teledisk() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
