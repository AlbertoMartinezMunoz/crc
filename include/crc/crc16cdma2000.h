#ifndef CRC_CRC16CDMA2000_H
#define CRC_CRC16CDMA2000_H

#include <crc/crc.h>

class Crc16Cdma2000 : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Cdma2000() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
