#ifndef CRC_CRC8DARC_H
#define CRC_CRC8DARC_H

#include <crc/crc.h>

class Crc8Darc : public Crc<uint8_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc8Darc() : Crc<uint8_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
