#ifndef CRC_CRC16DECTX_H
#define CRC_CRC16DECTX_H

#include <crc/crc.h>

class Crc16Dectx : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Dectx() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
