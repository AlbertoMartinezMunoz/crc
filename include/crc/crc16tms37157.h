#ifndef CRC_CRC16TMS37157_H
#define CRC_CRC16TMS37157_H

#include <crc/crc.h>

class Crc16Tms37157 : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Tms37157() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
...
private:
    ...
    static const uint16_t m_initialRemainder = 0x89EC;
};


#endif //CRC_CRC16TMS37157_H
