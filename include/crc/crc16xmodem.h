#ifndef CRC_CRC16XMODEM_H
#define CRC_CRC16XMODEM_H

#include <crc/crc.h>

class Crc16Xmodem : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Xmodem() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
