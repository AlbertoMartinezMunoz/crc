#ifndef CRC_CRC16ARC_H
#define CRC_CRC16ARC_H

#include <crc/crc.h>

class Crc16Arc : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Arc() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
