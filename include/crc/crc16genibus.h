#ifndef CRC_CRC16GENIBUS_H
#define CRC_CRC16GENIBUS_H

#include <crc/crc.h>

class Crc16Genibus : public Crc<uint16_t>
{
public:
    /**
     * Will construct a CRC class of type CRC16/USB
     */
    Crc16Genibus() : Crc<uint16_t>(m_lookupTable, m_initialRemainder, m_finalXorValue) {}
